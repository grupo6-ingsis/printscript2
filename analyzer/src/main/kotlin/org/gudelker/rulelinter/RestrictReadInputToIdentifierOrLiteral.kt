...
class RestrictReadInputToIdentifierOrLiteral(private val allowedTypes: List<KClass<out Statement>>) : RuleLinter {
    override fun matches(ruleMap: Map<String, LinterConfig>): Boolean {
        return ruleMap.values.any { it.restrictReadInputToIdentifierOrLiteral }
    }
